USE [master]
GO
/****** Object:  Database [MinhXuanDatabase]    Script Date: 4/5/2025 11:05:15 AM ******/
...
GO
/****** Object:  Table [dbo].[AccountVerifications]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[BlogCategories]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[BlogPosts]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Customers]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Employees]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Invoices]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Notifications]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetails]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductCategory]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductCategoryGroup]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductImage]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductReviews]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductTaxes]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductVariants]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Tax]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[ProductImage] ([ProductImageId], [ProductId], [FileName], [ImageURL], [Description], [CreatedAt], [UpdatedAt], [IsPrimary], [Status]) VALUES (12, 11, N'2e8fcd58-7f47-4191-9bf9-9ee7b4035518.webp', NULL, NULL, CAST(N'2025-04-04T17:06:57.017' AS DateTime), NULL, 1, 0)
GO
SET IDENTITY_INSERT [dbo].[ProductImage] OFF
GO
SET IDENTITY_INSERT [dbo].[Products] ON 
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [Slug], [CategoryId], [Description], [Material], [Origin], [Quantity], [Price], [Discount], [AverageRating], [TotalSale], [FreeShip], [Guarantee], [QualityCertificate], [TotalTax], [CreatedAt], [UpdatedAt], [Status]) VALUES (1, N'Mũ bảo hộ lao động kết hợp kính che mặt', N'mu-bao-ho-lao-dong-ket-hop-kinh-che-mat', 1, N'<ul><li>Mũ nhựa ABS kết hợp kính chắn bụi FC45 và gọng gắn kính A2</li><li>Dùng trong các nhà máy, xí nghiệp mài bảo vệ mặt, mắt và đầu</li></ul>', N'Nhựa ABS', N'Việt Nam', 102, CAST(125000.00 AS Decimal(18, 2)), CAST(10.00 AS Decimal(5, 2)), CAST(0.00 AS Decimal(4, 2)), 0, 1, 0, N'<p><br></p>', CAST(10.00 AS Decimal(5, 2)), CAST(N'2025-04-07T23:55:39.560' AS DateTime), CAST(N'2025-04-07T23:37:11.490' AS DateTime), 1)
GO
...
GO
INSERT [dbo].[Products] ([ProductId], [ProductName], [Slug], [CategoryId], [Description], [Material], [Origin], [Quantity], [Price], [Discount], [AverageRating], [TotalSale], [FreeShip], [Guarantee], [QualityCertificate], [TotalTax], [CreatedAt], [UpdatedAt], [Status]) VALUES (11, N'Phin lọc', N'phin-loc', 10, N'<p>Phin lọc độc, lọc bụi, xuất sứ Đài Loan</p><p>Phin lọc độc sử dụng trong trường hợp thay thế những phin không còn sử dụng được nữa như: Ngửi thấy mùi sơn, khó thở, ngửi thấy mùi hóa chất</p>', NULL, N'Đài Loan', 98, CAST(50000.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(5, 2)), CAST(0.00 AS Decimal(4, 2)), 0, 0, 0, N'<p> </p>', CAST(0.00 AS Decimal(5, 2)), CAST(N'2025-04-04T17:06:51.900' AS DateTime), NULL, 1)
GO
...
GO
INSERT [dbo].[ProductVariants] ([VariantId], [ProductId], [Size], [Color], [Quantity], [Price], [Discount], [Status], [CreatedAt], [UpdatedAt]) VALUES (1, 1, N'L(58 - 62 cm)', N'Xanh', 102, CAST(125000.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(5, 2)), 1, CAST(N'2025-04-07T16:55:39.367' AS DateTime), NULL)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__BlogCate__BC7B5FB608ECFD3F]    Script Date: 4/5/2025 11:05:16 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__BlogPost__BC7B5FB6C5768E3F]    Script Date: 4/5/2025 11:05:16 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Customer__A9D105341849F2F8]    Script Date: 4/5/2025 11:05:16 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Employee__A9D10534C4D860B3]    Script Date: 4/5/2025 11:05:16 AM ******/
ALTER TABLE [dbo].[Employees] ADD UNIQUE NONCLUSTERED 
(
	[Email] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [UQ__Invoices__C3905BCE49C22020]    Script Date: 4/5/2025 11:05:16 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Invoices__D776E98161EE16B5]    Script Date: 4/5/2025 11:05:16 AM ******/
ALTER TABLE [dbo].[Invoices] ADD UNIQUE NONCLUSTERED 
(
	[InvoiceNumber] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__ProductI__589E6EEC73C0058F]    Script Date: 4/5/2025 11:05:16 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Products__BC7B5FB6CA69BD2E]    Script Date: 4/5/2025 11:05:16 AM ******/
ALTER TABLE [dbo].[Products] ADD UNIQUE NONCLUSTERED 
(
	[Slug] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [UQ__ProductT__631D78E42ABA266F]    Script Date: 4/5/2025 11:05:16 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__ProductV__9BDF8B24C2AB60A5]    Script Date: 4/5/2025 11:05:16 AM ******/
...
GO
/****** Object:  Trigger [dbo].[trg_UpdateTotalSale]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[trg_UpdateTotalSale]
ON [dbo].[Orders]
AFTER UPDATE
AS
BEGIN
...
GO
/****** Object:  Trigger [dbo].[trg_Update_AverageRating]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_Update_Quantity_Products]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[trg_Update_Quantity_Products]
ON [dbo].[Products]
AFTER UPDATE
AS
BEGIN
...
GO
/****** Object:  Trigger [dbo].[trg_CalculateTotalTax]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[trg_CalculateTotalTax]
ON [dbo].[ProductTaxes]
...
GO
/****** Object:  Trigger [dbo].[trg_Update_Quantity_ProductVariants]    Script Date: 4/5/2025 11:05:16 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[trg_Update_Quantity_ProductVariants]
