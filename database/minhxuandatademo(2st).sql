...
GO
INSERT [dbo].[BlogCategories] ([CategoryBlogId], [CategoryName], [Slug], [Description]) VALUES (1, N'Liên hệ', N'lien-he', NULL)
GO
...
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (1, N'Địa chỉ', NULL, N'dia-chi', 1, N'Hai Bà Trưng, Hà Nội', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (2, N'Điện thoại', NULL, N'dien-thoai', 1, N'0912.423.062', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (3, N'Email', NULL, N'email', 1, N'minhxuanbhld@gmail.com', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (4, N'Zalo', NULL, N'zalo', 1, N'0912.423.062', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (5, N'Chính sách mua hàng', NULL, N'chinh-sach-mua-hang', 2, N'<p>Quý khách có thể mua hàng qua:</p><ul><li>Trực tiếp tại cửa hàng.</li><li>Đặt hàng qua website,hoặc hotline.</li><li>Mua hàng sỉ theo hợp đồng (đối với doanh nghiệp).</li></ul><p>Hỗ trợ tư vấn sản phẩm phù hợp theo nhu cầu sử dụng (công trình, cơ khí, điện lực, thực phẩm…).</p>', N'null', N'null', CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (6, N'Chính sách thanh toán', NULL, N'chinh-sach-thanh-toan', 2, N'', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (7, N'Chính sách vận chuyển', NULL, N'chinh-sach-van-chuyen', 2, N'<ul><li><strong>Giao hàng toàn quốc</strong> qua các đơn vị vận chuyển uy tín (GHN, GHTK, Viettel Post,…).</li><li>Miễn phí giao hàng với đơn từ 2.000.000đ trở lên (áp dụng nội thành HN/HCM).</li><li>Thời gian giao hàng: 1 – 5 ngày tùy khu vực.</li></ul>', N'null', N'null', CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (8, N'Hướng dẫn mua hàng', NULL, N'huong-dan-mua-hang', 3, N'', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (9, N'Hướng dẫn đổi trả', NULL, N'huong-dan-doi-tra', 3, N'', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (10, N'Hướng dẫn chuyển khoản', NULL, N'huong-dan-chuyen-khoan', 3, N'', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (11, N'Hướng dẫn trả góp', NULL, N'huong-dan-tra-gop', 3, N'', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (12, N'Hướng dẫn hoàn hàng', NULL, N'huong-dan-hoan-hang', 3, N'', NULL, NULL, CAST(N'2025-04-07T23:39:46.747' AS DateTime), NULL, N'Draft', NULL)
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (13, N'Banner1', NULL, N'banner1', 5, N'<p>banner1</p>', N'Banner1', NULL, CAST(N'2025-04-07T23:43:41.427' AS DateTime), NULL, N'Published', N'02a48656-8522-4e52-bfd1-eb902ad176bf.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (14, N'Banner2', NULL, N'banner2', 5, N'<p>Banner2<span class="ql-cursor">﻿</span></p>', N'Banner2', NULL, CAST(N'2025-04-07T23:44:07.940' AS DateTime), NULL, N'Published', N'e187206f-b2d1-4fd7-9188-c8c54555c904.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (15, N'Banner3', NULL, N'banner3', 5, N'<p>Banner3<span class="ql-cursor">﻿</span></p>', N'Banner3', NULL, CAST(N'2025-04-07T23:44:31.147' AS DateTime), NULL, N'Published', N'e078f70e-fbe1-4dde-833b-0704c84991de.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (16, N'Anh Minh', NULL, N'anh-minh', 6, N'<p>"Tôi đã mua bộ đồ bảo hộ tại cửa hàng và rất hài lòng với chất lượng. Áo quần chắc chắn, vải dày nhưng vẫn thoáng, chịu được môi trường bụi bẩn và nắng gắt. Mũ bảo hộ có lớp lót bên trong giúp đội lâu mà không bị đau đầu. Tôi sẽ tiếp tục đặt hàng cho đội công trình của mình."</p>', N'Kỹ sư công trình', NULL, CAST(N'2025-04-07T23:47:06.863' AS DateTime), NULL, N'Published', N'51b660a9-10d6-4a9e-9e76-894c2abe06f9.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (17, N'Chị Hồng', NULL, N'chi-hong', 6, N'<p>"Tôi đặt 20 bộ bảo hộ cho thợ trong xưởng, hàng giao đúng hẹn và chất lượng vượt mong đợi. Găng tay chịu nhiệt tốt, ủng chống trơn rất an toàn. Nhân viên tư vấn rất chuyên nghiệp và hỗ trợ nhiệt tình. Sẽ tiếp tục hợp tác lâu dài."</p>', N' Chủ xưởng cơ khí', N'null', CAST(N'2025-04-07T23:47:30.763' AS DateTime), NULL, N'Published', N'd2950529-63e9-4a9d-ac7c-0fb72dc5f62f.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (18, N'Anh Tùng', NULL, N'anh-tung', 6, N'<p>"Găng tay hàn và kính chắn tia UV ở đây dùng rất bền. Không bị rách sau vài lần dùng như mấy chỗ trước tôi mua. Cảm ơn shop đã giới thiệu đúng sản phẩm tôi cần!"</p>', N'Thợ hàn', NULL, CAST(N'2025-04-07T23:47:58.343' AS DateTime), NULL, N'Published', N'f7734b2b-aaaa-4ee5-bdf9-a9f0647245a7.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (19, N'Công ty TNHH Thành Đạt ', NULL, N'cong-ty-tnhh-thanh-dat', 6, N'<p>"Công ty chúng tôi đã tìm kiếm đối tác cung cấp thiết bị bảo hộ đạt chuẩn cho công nhân. Sau nhiều đơn vị, chúng tôi chọn bên bạn vì chất lượng ổn định, giá cả hợp lý và dịch vụ hậu mãi tốt. Sản phẩm luôn đầy đủ chứng nhận an toàn."</p>', N'Đại diện phòng vật tư', N'null', CAST(N'2025-04-07T23:48:25.737' AS DateTime), NULL, N'Published', N'7c2bd3dd-5997-4be2-81cb-714ebb426f53.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (20, N' Anh Dũng', NULL, N'anh-dung', 6, N'<p>"Nhân viên kho của tôi thường xuyên phải nâng vác hàng hóa. Giày bảo hộ mua từ bên bạn giúp họ an toàn hơn rất nhiều. Đế giày chống trơn, mũi giày chịu lực, lại không quá nặng nên đi thoải mái cả ngày."</p>', N'Quản lý kho', N'null', CAST(N'2025-04-07T23:48:58.307' AS DateTime), NULL, N'Published', N'3baf499d-d393-40e2-aac3-2b1d3ee3ef03.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (21, N'Chị Lan', NULL, N'chi-lan', 6, N'<p>"Tôi đặc biệt ấn tượng với khẩu trang chống bụi mịn bên bạn. Vừa khít mặt, không bị hở như các loại thường. Nhân viên mình làm việc trong môi trường bụi nhiều, từ khi dùng khẩu trang này thấy đỡ ho hẳn."</p>', N'Mua hàng ngành may mặc', N'null', CAST(N'2025-04-07T23:49:34.780' AS DateTime), NULL, N'Published', N'e631f418-dce1-4b40-8d6e-ba51b712a685.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (22, N'Cô Thảo', NULL, N'co-thao', 6, N'<p>"Chúng tôi yêu cầu trang phục bảo hộ phải sạch sẽ, thoáng mát, và đúng quy chuẩn HACCP. Bộ đồ của shop đáp ứng rất tốt, nhân viên mặc cảm thấy thoải mái trong ca làm việc dài."</p>', N'Quản lý nhà máy thực phẩm', N'null', CAST(N'2025-04-07T23:50:06.420' AS DateTime), NULL, N'Published', N'76de083b-7037-4a4a-98cd-37de7e6dcf41.webp')
GO
INSERT [dbo].[BlogPosts] ([PostId], [Title], [PostURL], [Slug], [CategoryBlogId], [Content], [Summary], [Tags], [CreatedAt], [UpdatedAt], [Status], [FileName]) VALUES (23, N'Anh Quang', NULL, N'anh-quang', 6, N'<p>"Tôi dùng giày chống tĩnh điện và găng tay cách điện mua tại shop. Hoàn toàn yên tâm khi làm việc. Sản phẩm có đầy đủ tem nhãn, rõ nguồn gốc và được kiểm định chất lượng."</p>', N' Kỹ thuật viên điện', NULL, CAST(N'2025-04-07T23:50:40.210' AS DateTime), NULL, N'Published', N'91bc2343-4ed6-49dd-889e-3142ad42cd2b.webp')
GO
...
GO
INSERT [dbo].[Employees] ([EmployeeId], [FullName], [Email], [PasswordHash], [PhoneNumber], [Address], [DateOfBirth], [Gender], [Role], [CreateAt], [UpdateAt], [Status]) VALUES (1, N'admin', N'admin@gmail.com', N'$2a$11$uQTwwfFB9WBJcvB2PAfg7ejM9Xsp.LJgY/0q82R.4Vk2d4zGvr00G', N'0123456789', N'ha noi', CAST(N'2002-03-09' AS Date), 1, N'Admin', CAST(N'2025-04-07T23:39:46.727' AS DateTime), NULL, N'Active')
GO
...
GO
INSERT [dbo].[ProductVariants] ([VariantId], [ProductId], [Size], [Color], [Quantity], [Price], [Discount], [Status], [CreatedAt], [UpdatedAt]) VALUES (1, 1, N'L(58 - 62 cm)', N'Vàng', 100, CAST(125000.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(5, 2)), 1, CAST(N'2025-04-07T16:55:39.367' AS DateTime), NULL)
GO
